 ...
 */
 class Lunar{
   ...
   */
   Lunar(int lunarYear,int lunarMonth,int lunarDay){
   ...
   * @param second 秒钟（阳历）
   */
   Lunar(int lunarYear,int lunarMonth,int lunarDay,int hour,int minute,int second){
   ...
   * @return 农历
   */
   static Lunar fromDate(Date date){
   ...
   * @return 农历
   */
   static Lunar fromYmd(int lunarYear,int lunarMonth,int lunarDay){
   ...
   * @return 农历
   */
   static Lunar fromYmdHms(int lunarYear,int lunarMonth,int lunarDay,int hour,int minute,int second){
