...
class SolarUtil {
  /** 阳历基准年 */
  static final int BASE_YEAR = 1901;
  /** 阳历基准月 */
  static final int BASE_MONTH = 1;
  /** 阳历基准日 */
  static final int BASE_DAY = 1;
  /** 星期*/
  static final List<String> WEEK = ["日", "一", "二", "三", "四", "五", "六"];
  /** 每月天数 */
  static final List<int> DAYS_OF_MONTH = [
    31,
    28,
    31,
    30,
  ...
  /** 星座 */
  static final List<String> XINGZUO = [
    "白羊",
    "金牛",
    "双子",
    "巨蟹",
  ...
  static int getWeeksOfMonth(int year, int month, int start) {
    ...
    var firstDayWeek = firstDate.weekday;
    return ((days + firstDayWeek - start) / 7).ceil();
  }
}
